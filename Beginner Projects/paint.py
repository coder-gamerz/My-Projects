...
class main:
    def __init__(self, master):
        ...
        self.ERASEr_button = Button(self.root, text='ERASE', font=('calibri', 10), bd=3, bg='white', command=self.ERASE,width=8, relief=RIDGE)
        self.ERASEr_button.place(x=0, y=215)
